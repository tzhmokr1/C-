// ---------------------------------------------------------
// color.h 
// Definiert den Aufzählungstyp ColorID und 
// die Klasse RGB_Color.
// ---------------------------------------------------------
#ifndef _RGB_COLOR_
#define _RGB_COLOR_

enum ColorID { BLACK, RED, GREEN, BLUE, YELLOW, CYAN, MAGENTA, WHITE, 
...
class RGB_Color
{
  ...
  public:
    ...
    RGB_Color(ColorID clr) { setColor(clr); }

    void setColor(int r, int g, int b)
    {  setR(r);  setG(g);  setB(b);   }

    void setColor(ColorID clr);
