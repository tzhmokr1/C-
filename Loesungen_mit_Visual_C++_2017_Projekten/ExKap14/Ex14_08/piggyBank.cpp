...
// Die Methode isLighterThan() vergleicht das Gewicht des aktuellen Sparschweins
// mit dem Gewicht eines anderen Sparschweins. 
// Return-Wert: true falls das aktuelle Sparschwein leichter ist, andernfalls false.
bool PiggyBank::isLighterThan( const PiggyBank& pb2)
{
    int weight1 = 2*nCent1  + 4*nCent10 + 
                  7*nCent50 + 7*nEuro1,
        weight2 = 2*pb2.nCent1  + 4*pb2.nCent10 + 
                  7*pb2.nCent50 + 7*pb2.nEuro1;
